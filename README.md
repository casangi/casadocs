...
# eg, you can be in one and do an ls on the other. casadocs can even be in the subdirectory casa6 subdirectory,
...
# virtual environment, as that is hard coded in casadocs scripts. You will need to activate this environment
...
# I don't know a good way to to that, so I'd just commit a dummy file and push that and when I was ready to issue
# the casadocs PR I'd remember to remove any dummy files I created.
