...
You are viewing a compilation of the Release Notes and XML (task/parameter) documentation from old CASA versions (4.7 - 6.1). CASA documentation for these old versions has been deprecated.
