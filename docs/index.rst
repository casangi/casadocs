...
- infrastructure: the CASA6 build system has been refactored to improve modularity within the code base, to better streamline dependency management, and to support evolving development and operations infrastructure at NRAO. The 6.5.6 release marks the start of production packages with the new build system. Both the old and new build systems will be supported in parallel until the end of the corresponding pipeline release cycle.
