...
.. list-table:: Title
   ...
   * - usemask
     - :code:`'user'`
     - Type of mask(s) for deconvolution:  user, pb, auto-multithresh, auto-thresh(deprecated, will be removed in CASA 5.4), or auto-thresh(deprecated, will be removed in CASA 5.4)
   * - mask
     - :code:`''`
...
Type of mask(s) to be used for deconvolution
                       ...
                       [Automasking algorithms available]
                       auto-multithresh (recommended) : automask by multiple thresholds for deconvolution
...
Mask (a list of image name(s) or region file(s) or region string(s)
                       ...
                       mask='xxx.mask'  : Use this CASA image named xxx.mask and containing
                                                       ...
                                                       If the mask is only different in spatial coordinates it will be
                                                       resampled to the target coordinate system before being used.
