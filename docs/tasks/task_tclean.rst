...
Examples
   ...
   See also, `Masks For Deconvolution <../../notebooks/synthesis_imaging.ipynb#Masks-for-Deconvolution>`__
   
   Mask by region text specification:
   
   ::

      tclean(vis='test.ms', imagename='try1', imsize=100, cell='10.0arcsec', 
             mask='box [[45pix, 45pix],[55pix, 55pix]]')
               
   Or alternatively, saving it in a text file:
  
   ::
     
      cat mybox.crtf
      #CRTFv0
      box [[45pix, 45pix],[55pix, 55pix]]
      tclean(vis='test.ms', imagename='try1', imsize=100, cell='10.0arcsec', 
             mask='mybox.crtf')
   
      
   Mulitple regions as a list of region strings:
    
   ::
    
      tclean(vis='test.ms', imagename='try1', imsize=100, cell='10.0arcsec', 
             specmode='cube', nchan=5,
             mask=['box [[45pix, 45pix],[55pix, 55pix]], range=[0chan, 2chan]',
                   'box [[50pix,55pix],[60pix,53pix]], range=[3chan, 4chan]'])
   
   
   Multiple regions in a CRTF file:
    
   ::
    
      cat myboxes.crtf
      #CRTFv0
      box [[45pix, 45pix],[55pix, 55pix]], range=[0chan, 2chan]
      box [[50pix,55pix],[60pix,53pix]], range=[3chan, 4chan]
      tclean(vis='test.ms', imagename='try1', imsize=100, cell='10.0arcsec', 
             specmode='cube', nchan=5, mask='myboxes.crtf)
           
           
   Multiple regions with mixed mask types:
    
   ::
    
      # mybox.crtf : a CRTF text file
      # myregion.rgn : a region record file generated by rg tool
      # my01.mask : 0/1 mask image
      tclean(vis='test.ms', imagename='try1', imsize=100, cell='10.0arcsec', 
             mask=['mybox.crtf','myregion.rgn', 'my01.mask', 
                   'poly [[55pix, 70pix],[57pix, 73pix],[59pix, 72pix],[60pix, 70pix],[58pix, 68pix]]'])
