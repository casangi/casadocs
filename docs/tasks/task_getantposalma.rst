...
the default snr as defined by the web service will be used. The server side default value may change over time as determined by the server side (non-CASA) team. As of this writing (March 2025), the web service team has not provided publicly facing documentation on the details of how the default value is chosen. The most recent information they have provided to us is that the default value is 5.0.
