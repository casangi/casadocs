...
Description
   ...
   in such instances after executing sdintimaging. As described in [the tclean section](../tasks/task_tclean.rst), model prediction can be done by running tclean by niter=0 and 
