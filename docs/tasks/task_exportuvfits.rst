...
Description
   ...
   *combinespw* parameter descriptions).
   ...
   .. warning:: Exporting of MSs with Nant>255 via **exportuvfits** should be considered experimental and datasets transported this way may not behave as expected in other packages (e.g., AIPS). 
