...
Parameters
   - **vis** (string) - Name of MS file or calibration table to flag [1]_
   - **inpmode** (string='table') - Input mode for flag commands(table/list/xml) [2]_

      .. raw:: html

         <details><summary><i> inpmode = table </i></summary>

      - **inpfile** ({string, stringArray}='') - Source of flag commands [3]_
      - **tablerows** (intArray=['']) - Rows of inpfile to read [4]_
      - **reason** ({string, stringArray}='any') - Select by REASON types [5]_
      - **useapplied** (bool=False) - Select commands whose rows have APPLIED column set to True [6]_
      ...
      - **tbuff** (double=0.0) - Time buffer (sec) to pad flags [7]_
      - **ants** (string='') - Allowed flag antenna names to select by [8]_
      - **reason** ({string, stringArray}='any') - Select by REASON types [5]_

      .. raw:: html

         </details>
   - **action** (string='apply') - Action to perform in MS and/or in inpfile (apply/unapply/list/plot/clear/extract) [9]_

      .. raw:: html

         <details><summary><i> action = apply </i></summary>

      - **flagbackup** (bool=True) - Automatically backup the FLAG column before execution [10]_
      ...
      - **plotfile** (string='') - Name of output file to save plot [13]_
      ...
      - **clearall** (bool=False) - Delete all rows from FLAG_CMD [11]_
      - **rowlist** (intArray=['']) - FLAG_CMD rows to clear [12]_

      .. raw:: html

         </details>
   - **savepars** (bool=False) - Save flag commands to the MS or file [14]_

      .. raw:: html

         <details><summary><i> savepars = True </i></summary>

      - **outfile** (string='') - Name of output file to save commands [15]_
      - **overwrite** (bool=True) - Overwrite an existing file to save the flag commands [16]_
