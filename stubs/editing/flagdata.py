...
Parameters
   ...
   - **mode** (string='manual') - Flagging mode (list/manual/clip/quack/shadow/elevation/tfcrop/rflag/antint/extent/unflag/summary) [2]_

      .. raw:: html

         <details><summary><i> mode = manual </i></summary>

      - **field** ({string, stringArray}='') - Select field using field id(s) or field name(s) [8]_
      - **spw** ({string, stringArray}='') - Select spectral window/channels [7]_
      - **antenna** ({string, stringArray}='') - Select data based on antenna/baseline [9]_
      - **timerange** ({string, stringArray}='') - Select data based on time range [11]_
      - **correlation** ({string, stringArray}='') - Select data based on correlation [12]_
      - **scan** ({string, stringArray}='') - Scan number range [13]_
      - **intent** ({string, stringArray}='') - Select observing intent [14]_
      - **array** ({string, stringArray}='') - (Sub)array numbers [15]_
      - **uvrange** ({string, stringArray}='') - Select data by baseline length. [10]_
      - **observation** ({string, int}='') - Select by observation ID(s) [16]_
      - **feed** ({string, stringArray}='') - Multi-feed numbers: Not yet implemented [17]_
      - **autocorr** (bool=False) - Flag only the auto-correlations? [3]_
      ...
      - **inpfile** ({string, stringArray}='') - Input ASCII file, list of files or Python list of strings with flag commands. [4]_
      - **reason** ({string, stringArray}='any') - Select by REASON types [5]_
      - **tbuff** ({double, doubleArray}=0.0) - List of time buffers (sec) to pad timerange in flag commands [6]_
      ...
      - **observation** ({string, int}='') - Select by observation ID(s) [16]_
      - **feed** ({string, stringArray}='') - Multi-feed numbers: Not yet implemented [17]_
      - **datacolumn** ({string, stringArray}='DATA') - Data column on which to operate [19]_
      - **clipminmax** (doubleArray=['']) - Range to use for clipping [18]_
      - **clipoutside** ({bool, boolArray}=True) - Clip outside the range, or within it [20]_
      - **channelavg** ({bool, boolArray}=False) - Pre-average data across channels before analyzing visibilities for flagging [21]_
      - **chanbin** ({int, intArray}=1) - Bin width for channel average in number of input channels [22]_
      - **timeavg** ({bool, boolArray}=False) - Pre-average data across time before analyzing visibilities for flagging. [23]_
      - **timebin** (string='0s') - Bin width for time average in seconds [24]_
      - **clipzeros** (bool=False) - Clip zero-value data [25]_
      ...
      - **observation** ({string, int}='') - Select by observation ID(s) [16]_
      - **feed** ({string, stringArray}='') - Multi-feed numbers: Not yet implemented [17]_
      - **quackinterval** ({double, doubleArray, int, intArray}=1.0) - Quack n seconds from scan beginning or end [26]_
      - **quackmode** ({string, stringArray}='beg') - Quack mode. Flag intervals of the scan according to given mode. [27]_
      - **quackincrement** ({bool, boolArray}=False) - Increment quack flagging in time taking into account flagged data or not. [28]_
      ...
      - **observation** ({string, int}='') - Select by observation ID(s) [16]_
      - **feed** ({string, stringArray}='') - Multi-feed numbers: Not yet implemented [17]_
      - **tolerance** (double=0.0) - Amount of shadow allowed (in meters) [29]_
      - **addantenna** ({string, record}='') - File name or dictionary with additional antenna names, positions and diameters [30]_
      ...
      - **observation** ({string, int}='') - Select by observation ID(s) [16]_
      - **feed** ({string, stringArray}='') - Multi-feed numbers: Not yet implemented [17]_
      - **lowerlimit** (double=0.0) - Lower limiting elevation (in degrees) [31]_
      - **upperlimit** (double=90.0) - Upper limiting elevation (in degrees) [32]_
      ...
      - **observation** ({string, int}='') - Select by observation ID(s) [16]_
      - **feed** ({string, stringArray}='') - Multi-feed numbers: Not yet implemented [17]_
      - **ntime** ({double, string}='scan') - Time-range to use for each chunk (in seconds or minutes) [33]_
      - **combinescans** (bool=False) - Accumulate data across scans depending on the value of ntime. [34]_
      - **datacolumn** ({string, stringArray}='DATA') - Data column on which to operate [19]_
      - **timecutoff** (double=4.0) - Flagging thresholds in units of deviation from the fit [35]_
      - **freqcutoff** (double=3.0) -  Flagging thresholds in units of deviation from the fit [36]_
      - **timefit** (string='line') - Fitting function for the time direction (poly/line) [37]_
      - **freqfit** (string='poly') - Fitting function for the frequency direction (poly/line) [38]_
      - **maxnpieces** (int=7) - Number of pieces in the polynomial-fits (for freqfit or timefit poly) [39]_
      - **flagdimension** (string='freqtime') - Dimensions along which to calculate fits (freq, time, freqtime, timefreq) [40]_
      - **usewindowstats** (string='none') - Calculate additional flags using sliding window statistics (none, sum, std, both) [41]_
      - **halfwin** (int=1) - Half-width of sliding window to use with usewindowstats (1,2,3). [42]_
      - **extendflags** (bool=True) - Extend flags along time, frequency and correlation. [43]_
      - **channelavg** ({bool, boolArray}=False) - Pre-average data across channels before analyzing visibilities for flagging [21]_
      - **chanbin** ({int, intArray}=1) - Bin width for channel average in number of input channels [22]_
      - **timeavg** ({bool, boolArray}=False) - Pre-average data across time before analyzing visibilities for flagging. [23]_
      - **timebin** (string='0s') - Bin width for time average in seconds [24]_
      ...
      - **combinescans** (bool=False) - Accumulate data across scans depending on the value of ntime. [34]_
      - **datacolumn** ({string, stringArray}='DATA') - Data column on which to operate [19]_
      - **winsize** (int=3) - Number of timesteps in the sliding time window [44]_
      - **timedev** (variant='') - Time-series noise estimate [45]_
      - **freqdev** (variant='') - Spectral noise estimate [46]_
      - **timedevscale** (double=5.0) - Threshold scaling for timedev [47]_
      - **freqdevscale** (double=5.0) - Threshold scaling for freqdev. [48]_
      - **spectralmax** (double=1E6) - Flag whole spectrum if freqdev is greater than spectralmax [49]_
      - **spectralmin** (double=0.0) - Flag whole spectrum if freqdev is less than spectralmin [50]_
      - **extendflags** (bool=True) - Extend flags along time, frequency and correlation. [43]_
      - **channelavg** ({bool, boolArray}=False) - Pre-average data across channels before analyzing visibilities for flagging [21]_
      - **chanbin** ({int, intArray}=1) - Bin width for channel average in number of input channels [22]_
      - **timeavg** ({bool, boolArray}=False) - Pre-average data across time before analyzing visibilities for flagging. [23]_
      ...
      - **antenna** ({string, stringArray}='') - Select data based on antenna/baseline [9]_
      - **datacolumn** ({string, stringArray}='DATA') - Data column on which to operate [19]_
      - **antint_ref_antenna** (string='') - Antenna of interest. Baselines with this antenna will be checked for flagged channels. [51]_
      - **minchanfrac** (double=0.6) - Minimum fraction of flagged channels required for a baseline to be deemed as flagged [52]_
      - **verbose** (bool=False) - Print timestamps of flagged integrations to the log [53]_
      ...
      - **ntime** ({double, string}='scan') - Time-range to use for each chunk (in seconds or minutes) [33]_
      - **combinescans** (bool=False) - Accumulate data across scans depending on the value of ntime. [34]_
      - **extendpols** (bool=True) - If any correlation is flagged, flag all correlations [54]_
      - **growtime** (double=50.0) - Flag all ntime integrations if more than X percent of the timerange is flagged (0-100) [55]_
      - **growfreq** (double=50.0) - Flag all selected channels if more than X percent of the frequency range is flagged (0-100) [56]_
      - **growaround** (bool=False) - Flag data based on surrounding flags [57]_
      - **flagneartime** (bool=False) - Flag one timestep before and after a flagged one (True/False) [58]_
      - **flagnearfreq** (bool=False) - Flag one channel before and after a flagged one (True/False) [59]_
      ...
      - **observation** ({string, int}='') - Select by observation ID(s) [16]_
      - **feed** ({string, stringArray}='') - Multi-feed numbers: Not yet implemented [17]_
      - **minrel** (double=0.0) - Minimum number of flags (relative) [60]_
      - **maxrel** (double=1.0) - Maximum number of flags (relative) [61]_
      - **minabs** (int=0) - Minimum number of flags (absolute) [62]_
      - **maxabs** (int=-1) - Maximum number of flags (absolute). Use a negative value to indicate infinity. [63]_
      - **spwchan** (bool=False) - Print summary of channels per spw [64]_
      - **spwcorr** (bool=False) - Print summary of correlation per spw [65]_
      - **basecnt** (bool=False) - Print summary counts per baseline [66]_
      - **fieldcnt** (bool=False) - Produce a separated breakdown for each field [67]_
      - **name** (string='Summary') - Name of this summary report (key in summary dictionary) [68]_

      .. raw:: html

         </details>
   - **action** (string='apply') - Action to perform in MS and/or in inpfile (none/apply/calculate) [69]_

      .. raw:: html

         <details><summary><i> action = apply </i></summary>

      - **display** (string='') - Display data and/or end-of-MS reports at runtime (data/report/both). [70]_
      - **flagbackup** (bool=True) - Back up the state of flags before the run [71]_
   ...
   - **savepars** (bool=False) - Save the current parameters to the FLAG_CMD table or to a file [72]_

      .. raw:: html

         <details><summary><i> savepars = True </i></summary>

      - **cmdreason** (string='') - Reason to save to output file or to FLAG_CMD table. [73]_
      - **outfile** (string='') - Name of output file to save current parameters. If empty, save to FLAG_CMD [74]_
      - **overwrite** (bool=True) - Overwrite an existing file to save the flag commands [75]_
