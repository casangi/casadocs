...
Parameters
   ...
   - **caltable** (string='') - Name of input calibration table [2]_
   - **fluxtable** (string='') - Name of output, flux-scaled calibration table (required) [3]_
   - **reference** (stringArray=['']) - Reference field name(s) (transfer flux scale FROM) [4]_
   - **transfer** (stringArray=['']) - Transfer field name(s) (transfer flux scale TO), \'\' -> all [5]_
   - **listfile** (string='') - Name of listfile that contains the fit information.  Default is '' (no file). [6]_
   - **append** (bool=False) - Append solutions? [7]_
   - **refspwmap** (intArray=[-1]) - Scale across spectral window boundaries [8]_
   - **gainthreshold** (double=-1.0) - Threshold (fractional deviation from the median) on gain amplitudes to be used in the flux scale calculation [9]_
   - **antenna** (string='') - Select data based on antenna/baseline [10]_
   - **incremental** (bool=False) - Incremental caltable [13]_
   - **fitorder** (int=1) - Order of spectral fitting [14]_
   - **display** (bool=False) - Display some statistics of flux scaling [15]_
