...
Parameters
   ...
   - **caltype** (string='') - The calibration type: (amp, ph, sbd, mbd, antpos, antposvla, tsys, evlagain, opac, gc, gceff, eff, tecim) [3]_

      .. raw:: html

         <details><summary><i> caltype = tecim </i></summary>

      - **infile** (string='') - Input ancilliary file [4]_
      ...
      - **uniform** (bool=True) - Assume uniform calibration values across the array [9]_
   ...
   - **pol** (string='') - Calibration polarizations(s) selection [7]_
   - **parameter** (doubleArray=['']) - The calibration values [8]_
