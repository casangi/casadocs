...
Parameters
   ...
   - **append** (bool=False) - Append solutions to the (existing) table [14]_
   - **docallib** (bool=False) - Use callib or traditional cal apply parameters [15]_

      .. raw:: html

         <details><summary><i> docallib = False </i></summary>

      - **gaintable** (stringArray=['']) - Gain calibration table(s) to apply on the fly [17]_
      - **gainfield** (stringArray=['']) - Select a subset of calibrators from gaintable(s) [18]_
      - **interp** (stringArray=['']) - Interpolation parameters for each gaintable, as a list [19]_
      - **spwmap** (intArray=['']) - Spectral windows combinations to form for gaintables(s) [20]_
      ...
      - **callib** (string='') - Cal Library filename [16]_
