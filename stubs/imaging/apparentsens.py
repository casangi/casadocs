...
Parameters
   ...
   - **selectdata** (bool=True) - Enable data selection parameters [5]_

      .. raw:: html

         <details><summary><i> selectdata = True </i></summary>

      - **field** ({string, stringArray}='') - field(s) to select [2]_
      - **spw** ({string, stringArray}='') - spw(s)/channels to select [3]_
      - **timerange** ({string, stringArray}='') - Range of time to select from data [6]_
      - **uvrange** ({string, stringArray}='') - Select data within uvrange [7]_
      - **antenna** ({string, stringArray}='') - Select data based on antenna/baseline [8]_
      - **scan** ({string, stringArray}='') - Scan number range [9]_
      - **observation** ({string, int}='') - Observation ID range [10]_
      - **intent** ({string, stringArray}='') - Scan Intent(s) [4]_

      .. raw:: html

         </details>
   - **imsize** ({int, intArray}=100) - Number of pixels [11]_
   - **cell** ({int, double, intArray, doubleArray, string, stringArray}='"1arcsec"') - Cell size [12]_
   - **stokes** (string='I') - Stokes Planes to make (I only, for now) [13]_
   - **specmode** (string='mfs') - Spectral definition mode (mfs only, for now) [14]_
   - **weighting** (string='natural') - Weighting scheme (natural,uniform,briggs) [15]_

      .. raw:: html

         <details><summary><i> weighting = natural </i></summary>

      - **uvtaper** (stringArray=['']) - uv-taper on outer baselines in uv-plane [18]_
      ...
      - **robust** (double=0.5) - Robustness parameter [16]_
      - **npixels** (int=0) - Number of pixels to determine uv-cell size (0 : -/+ 3 pixels) [17]_
      - **uvtaper** (stringArray=['']) - uv-taper on outer baselines in uv-plane [18]_
