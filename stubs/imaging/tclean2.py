...
Parameters
   ...
   - **projection** (string='SIN') - Coordinate projection (SIN, HPX) [17]_
   - **startmodel** (string='') - Name of starting model image [18]_
   - **specmode** (string='mfs') - Spectral definition mode (mfs,cube,cubedata) [19]_
      ...
      - **chanchunks** (int=1) - Number of channel chunks [30]_
   ...
   - **gridder** (string='standard') - Gridding options (standard, wproject, widefield, mosaic, awproject) [28]_

      .. raw:: html

         <details><summary><i> gridder = widefield </i></summary>

      - **wprojplanes** (int=1) - Number of distinct w-values for convolution functions [31]_
      - **facets** (int=1) - Number of facets on a side [29]_
      ...
      - **pblimit** (double=0.2) - >PB gain level at which to cut off normalizations  [39]_
      - **normtype** (string='flatnoise') - Normalization type (flatnoise, flatsky) [40]_
      ...
      - **pblimit** (double=0.2) - >PB gain level at which to cut off normalizations  [39]_
      - **normtype** (string='flatnoise') - Normalization type (flatnoise, flatsky) [40]_
      - **psterm** (bool=False) - Use prolate spheroidal during gridding [33]_
      - **aterm** (bool=True) - Use aperture illumination functions during gridding [32]_
      - **cfcache** (string='') - >Convolution function cache directory name [36]_
      - **computepastep** (double=360.0) - At what parallactic angle interval to recompute AIFs (deg) [37]_
      - **rotatepastep** (double=360.0) - At what parallactic angle interval to rotate nearest AIF (deg)  [38]_
      - **wbawp** (bool=True) - Use wideband A-terms [34]_
      - **conjbeams** (bool=True) - Use conjugate frequency for wideband A-terms [35]_
   ...
   - **deconvolver** (string='hogbom') - Minor cycle algorithm (hogbom,clark,multiscale,mtmfs,mem,clarkstokes) [41]_

      .. raw:: html

         <details><summary><i> deconvolver = hogbom </i></summary>

      - **restoringbeam** ({string, stringArray}='') - Restoring beam shape to use. Default is the PSF main lobe [45]_
      ...
      - **scales** ({intArray, floatArray}=['']) - List of scale sizes (in pixels) for multi-scale algorithms [42]_
      - **restoringbeam** ({string, stringArray}='') - Restoring beam shape to use. Default is the PSF main lobe [45]_
      ...
      - **scales** ({intArray, floatArray}=['']) - List of scale sizes (in pixels) for multi-scale algorithms [42]_
      - **nterms** (int=2) - Number of Taylor coefficients in the spectral model [43]_
      - **restoringbeam** ({string, stringArray}='') - Restoring beam shape to use. Default is the PSF main lobe [45]_
   ...
   - **outlierfile** (string='') - Name of outlier-field image definitions [46]_
   - **weighting** (string='natural') - Weighting scheme (natural,uniform,briggs) [47]_

      .. raw:: html

         <details><summary><i> weighting = natural </i></summary>

      - **uvtaper** (stringArray=['']) - uv-taper on outer baselines in uv-plane [50]_
      ...
      - **robust** (double=0.5) - Robustness parameter [48]_
      - **npixels** (int=0) - Number of pixels to determine uv-cell size (0 : -/+ 3 pixels) [49]_
      - **uvtaper** (stringArray=['']) - uv-taper on outer baselines in uv-plane [50]_

      .. raw:: html

         </details>
   - **niter** (int=0) - Maximum number of iterations [51]_
   - **usemask** (string='user') - Type of mask(s) for deconvolution (user,pb,auto-thresh) [59]_

      .. raw:: html

         <details><summary><i> usemask = user </i></summary>

      - **mask** ({string, stringArray}='') - Mask (a list of image name(s) or region file(s) or region string(s) ) [60]_
      - **pbmask** (double=0.0) - primary beam mask [61]_
      ...
      - **pbmask** (double=0.0) - primary beam mask [61]_
      - **maskthreshold** (string='') - threshold for automasking (string with unit, e.g. "1.0mJy", sigma,  or fraction of peak ,e.g. 0.1) [62]_
      - **maskresolution** (string='') - resolution for automasking (string, e.g. "10arcsec") [63]_

      .. raw:: html

         </details>
   - **restart** (bool=True) - True : Re-use existing images. False : Increment imagename [64]_
   - **savemodel** (string='none') - Options to save model visibilities (none, virtual, modelcolumn) [65]_
   - **makeimages** (string='auto') - List of output images (auto,choose) [66]_

      .. raw:: html

         <details><summary><i> makeimages = choose </i></summary>

      - **calcres** (bool=True) - Calculate initial residual image [67]_
      - **calcpsf** (bool=True) - Calculate PSF [68]_
      - **restoremodel** (string='auto') - Restore the model image [69]_
      - **writepb** (string='auto') - Make a primary beam image [70]_

      .. raw:: html

         </details>
   - **ranks** (intarray='') - List of participating ranks [71]_
