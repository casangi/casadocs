...
Parameters
   ...
   - **selectdata** (bool=False) - Other data selection parameters [4]_

      .. raw:: html

         <details><summary><i> selectdata = True </i></summary>

      - **timerange** ({string, stringArray}='') - Select data based on time range [5]_
      - **scan** ({string, stringArray}='') - Scan number range [6]_
      - **intent** (string='') - Select observing intent [7]_
      - **observation** ({string, int}='') - Select by observation ID(s) [8]_

      .. raw:: html

         </details>
   - **scalebychan** (bool=True) - Scale the flux density on a per channel basis or else on a per spw basis [9]_
   - **standard** (string='Perley-Butler 2017') - Flux density standard [10]_

      .. raw:: html

         <details><summary><i> standard = Perley-Butler 2017 </i></summary>

      - **model** (string='') - File location for field model [11]_
      - **listmodels** (bool=False) - List the available models for VLA calibrators or Tb models for Solar System objects [13]_
      - **interpolation** (string='nearest') - Method to be used to interpolate in time [22]_
      ...
      - **listmodels** (bool=False) - List the available models for VLA calibrators or Tb models for Solar System objects [13]_
      - **useephemdir** (bool=False) - Use directions in the ephemeris table [21]_
      ...
      - **fluxdensity** ({int, intArray, doubleArray}=-1) - Specified flux density in Jy [I,Q,U,V]; (-1 will lookup values) [14]_
      - **spix** ({double, doubleArray}=0.0) - Spectral index (including higher terms) of I fluxdensity [15]_
      - **reffreq** (string='1GHz') - Reference frequency for spix [16]_
      - **polindex** (doubleArray=['']) - Coefficients of an expansion of frequency-dependent linear polarization fraction expression [17]_
      - **polangle** (doubleArray=['']) - Coefficients of an expansion of frequency-dependent polarization angle expression (in radians) [18]_
      - **rotmeas** (double=0.0) - Rotation measure (in rad/m^2) [19]_
      ...
      - **fluxdict** (record='') - Output dictionary from fluxscale [20]_

      .. raw:: html

         </details>
   - **usescratch** (bool=False) - Will create if necessary and use the MODEL_DATA  [23]_
