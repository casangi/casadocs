...
class flagdata_suite:
    ...
    """
    dataroot = ctsys.resolve(os.path.join(os.environ.get('ASV_CONF_DIR'),'casatestdata/performance/flagdata_runtime/'))
...
class calibration_suite:
    ...
    """
    dataroot = ctsys.resolve(os.path.join(os.environ.get('ASV_CONF_DIR'),'casatestdata/performance/calibration_runtime/'))
